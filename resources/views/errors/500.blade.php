...
<body>
    <div class="card">
        ...
        <h1>Server Error</h1>
        <p>Terjadi kesalahan di server. Tim kami sudah mengetahuinya dan sedang diperbaiki. Coba lagi dalam beberapa saat.</p>
        <div class="links">
            <a href="/" class="btn-primary">← Beranda</a>
            <a href="javascript:location.reload()" class="btn-secondary">🔄 Coba Lagi</a>
        </div>
    </div>
</body>
</html>
