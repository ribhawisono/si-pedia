<x-auth-layout title="Login — SI-Pedia">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="relative mt-7">
            ...
            <button type="button" id="toggle-login-password" aria-label="Lihat password"
                    class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 focus:outline-none">
                <svg id="toggle-login-password-icon" class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 13c3-4 7-5 10-5s7 1 10 5" stroke-linecap="round"/></svg>
            </button>
        </div>
    ...
    (function() {
        ...
        btn.addEventListener('click', () => {
            ...
            icon.innerHTML = show
                ? '<path d="M2 13c3-4 7-5 10-5s7 1 10 5" stroke-linecap="round"/><path d="M12 16a3 3 0 100-6 3 3 0 000 6z"/>'
                : '<path d="M2 13c3-4 7-5 10-5s7 1 10 5" stroke-linecap="round"/>';
        });
    })();
    </script>
</x-auth-layout>
