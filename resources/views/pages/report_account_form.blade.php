  ...
  <form action="{{ route('users.report.store', $user) }}" method="POST"
    ...
    <div>
      ...
      <select name="reason" required
        ...
        <option value="Informasi palsu" @selected(old('reason') === 'Informasi palsu')>Menyebarkan informasi palsu</option>
        <option value="Penyalahgunaan akun" @selected(old('reason') === 'Penyalahgunaan akun')>Penyalahgunaan akun</option>
        <option value="Identitas palsu" @selected(old('reason') === 'Identitas palsu')>Identitas palsu / impersonasi</option>
        <option value="Perundungan" @selected(old('reason') === 'Perundungan')>Perundungan atau pelecehan</option>
    ...
    <div>
      ...
      <textarea name="description" rows="5" maxlength="1000"
                placeholder="Jelaskan lebih detail mengapa kamu melaporkan akun ini..."
