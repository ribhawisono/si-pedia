...
<main class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
  ...
  <div class="hidden lg:grid grid-cols-[60px_120px_1fr_130px_110px_150px_140px_200px] gap-2 rounded-xl bg-tablehead px-4 py-3 text-sm font-bold text-gray-800">
