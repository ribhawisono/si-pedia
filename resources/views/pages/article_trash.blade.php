...
<main class="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
  <div class="flex items-start justify-between">
    <div>
      ...
      <p class="mt-1 text-gray-700">Artikel yang dihapus. Bisa dipulihkan atau dihapus permanen.</p>
    </div>
  ...
  <div class="mt-6 hidden lg:grid grid-cols-[60px_1fr_130px_110px_150px_200px] gap-2 rounded-xl bg-tablehead px-4 py-3 text-sm font-bold text-gray-800">
    <div>No</div><div>Judul Artikel</div><div>Kategori</div><div>Penulis</div><div>Dihapus</div><div>Action</div>
  </div>

  <div class="mt-3 space-y-3">
    @forelse($articles as $i => $article)
    <div class="hidden lg:grid grid-cols-[60px_1fr_130px_110px_150px_200px] items-start gap-2 rounded-2xl bg-white px-4 py-4 shadow-[0_2px_10px_rgba(0,0,0,0.06)] overflow-hidden">
