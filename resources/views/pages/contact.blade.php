...
<section class="bg-white py-12 sm:py-16">
  <div class="mx-auto grid max-w-[900px] gap-6 px-4 sm:px-8 sm:grid-cols-2">
  ...
  <div class="mx-auto mt-8 max-w-[900px] px-4 sm:px-8">
    <div class="rounded-2xl bg-ink-900 p-6 sm:p-8 text-center">
